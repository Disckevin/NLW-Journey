...
const criarItemDeAtividade = (atividade) => {
  ...
  `
  document.getElementById("circle-check").innerHTML = `
  <img class="active" src="./assets/circle-check.svg" alt="ativo">
  ` 

  document.getElementById("circle-dashed").innerHTML = `
  <img class="inactive" src="./assets/circle-dashed.svg" alt="ativo">
  ` 
}
